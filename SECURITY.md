...
1. **GitHub Private Vulnerability Reporting (Preferred)**: Navigate to the [Security Tab](https://github.com/SteveShi/MDEditorKit/security) of this repository and click **"Report a vulnerability"**.
...
## Parser Safety Principles

- **ReDoS Mitigation**: Regular expressions and AST parsers are structured to prevent catastrophic backtracking when handling complex or maliciously crafted markdown syntax.
- **Memory Safety**: TextKit 2 layout managers and text containers are bound by strict memory and range validation checks.
